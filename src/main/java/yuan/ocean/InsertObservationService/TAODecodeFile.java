        ...
        if (file.exists()){
            try {
                ...
                if (linkedProperty.containsKey("lat")&&linkedProperty.containsKey("lon")){
                    latPos=Integer.valueOf(linkedProperty.get("lat"));
                    lonPos = Integer.valueOf(linkedProperty.get("lon"));
                            ...
                            if (isSensorMatchProperty(linkedProperty,sensor)) {
                                ...
                                for (ObservedProperty property : sensor.getObservedProperties()) {
                                    ...
                                    if (eles[Integer.valueOf(linkedProperty.get(property.getPropertyID()))].equals("NaN"))
                                        ...
                                        property.setDataValue(eles[Integer.valueOf(linkedProperty.get(property.getPropertyID()))]);
                                }
